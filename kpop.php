...
<body>
    ...
    <div class="top-wrapper" style="overflow:auto;">
        <div class="container">
    <?php  
         $sql = "CREATE TABLE IF NOT EXISTS kpop"
 ." ("
 ...
 .");";
    ...
    if(isset($_POST["Ssubmit"])
        ...
        $pass1=$_POST["pass1"];
         $stmt = $pdo->query($sql);
    $sql = $pdo -> prepare("INSERT INTO kpop (name, comment,created, pass) 
    ...
    $sql -> execute();
     ...
     $sql = 'UPDATE kpop SET name=:name,comment=:comment,created=:created,pass=:pass WHERE id=:id';
